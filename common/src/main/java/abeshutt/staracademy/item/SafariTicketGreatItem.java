...
public class SafariTicketGreatItem extends Item {
    
    public SafariTicketGreatItem() {
        super(new Settings());
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        // Great ticket gives 25 minutes (20 * 60 * 25 ticks)
        int time = 20 * 60 * 25;
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        tooltip.add(Text.literal("Adds 25 minutes to your Safari timer.").formatted(Formatting.GRAY));
    }
